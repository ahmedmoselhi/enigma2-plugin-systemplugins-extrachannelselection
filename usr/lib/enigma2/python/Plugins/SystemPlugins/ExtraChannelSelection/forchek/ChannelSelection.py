...
# Embedded file name: /usr/lib/enigma2/python/Screens/ChannelSelection.py
# Compiled at: 2018-05-05 06:11:07
...
class ChannelSelectionEPG(InfoBarButtonSetup):
    ...
    def __init__(self):
        ...
        self['ChannelSelectEPGActions'] = ActionMap(['ChannelSelectInfoActions', 'ChannelSelectEPGActions'], {'showEPGList': (self.showEPGList), 
...
# okay decompiling ./forchek/ChannelSelection.pyo
