...
def StartMainSession(reason, **kwargs):
    ...
    if allow:
        if config.plugins.ExtraChannelSelection.enabled.value:
            ...
            if sizeSki == 1920:
                import ServiceListhd
                import Screens.ChannelSelection
                import ChannelSelectionhd
...
class PluginHistory(Screen):
    ...
    def __init__(self, session):
        ...
        self['shortcuts'] = ActionMap(['ShortcutActions', 'WizardActions'], {'cancel': self.cancel,
         'back': self.cancel,
         'red': self.cancel,
         'ok': self.cancel})
...
class ExtraChannelSelection(Screen, ConfigListScreen):
    ...
    def __init__(self, session):
        ...
        self['setupActions'] = ActionMap(['SetupActions', 'OkCancelActions', 'ColorActions'], {'red': self.cancel,
         'cancel': self.cancel,
         'green': self.save,
         'yellow': self.info,
         'blue': self.back,
