...
# Embedded file name: usr\lib\enigma2\python\Plugins\SystemPlugins\ExtraChannelSelection\ChannelSelectionhd.py
# Compiled at: 2017-07-03 04:27:51
...
from ServiceListhd import ServiceList, refreshServiceList
...
class ChannelContextMenu(Screen):
    ...
    def __init__(self, session, csel):
        ...
        self['actions'] = ActionMap(['OkCancelActions', 'ColorActions', 'NumberActions', 'MenuActions'], {'ok': (self.okbuttonClick), 
           'cancel': (self.cancelClick), 
...
class ChannelSelectionEPG(InfoBarButtonSetup):
    ...
    def __init__(self):
        ...
        self['recordingactions'] = HelpableActionMap(self, 'InfobarInstantRecord', {'ShortRecord': (
                         self.RecordTimerQuestion, _('Add a record timer')), 
           'LongRecord': (
    ...
    def RecordTimerQuestion(self):
        ...
        if len(self.list) < 1:
            ...
            if eventidnext is not None:
                menu = [
                 (
                  menu1, 'CALLFUNC', self.ChoiceBoxCB, self.doRecordCurrentTimer), (menu2, 'CALLFUNC', self.ChoiceBoxCB, self.doRecordNextTimer)]
            else:
                menu = [
                 (
...
class ChannelSelectionBase(Screen):
    ...
    def __init__(self, session):
        ...
        self['ChannelSelectBaseActions'] = NumberActionMap(['ChannelSelectBaseActions', 'NumberActions', 'InputAsciiActions'], {'ServiceDown': (self.moveDown), 
...
class ChannelSelectionRadio(ChannelSelectionBase, ChannelSelectionEdit, ChannelSelectionEPG, InfoBarBase, SelectionEventInfo):
    ...
    def __init__(self, session, infobar):
        ...
        self['RdsActions'] = HelpableActionMap(self, 'InfobarRdsActions', {'startRassInteractive': (
                                  self.startRassInteractive, _('View Rass interactive...'))}, -1)
...
# okay decompiling ./ChannelSelectionhd.pyo
